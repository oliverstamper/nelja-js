...
for (var i = 1; i < finances.length; i++) {
  ...
  if (change > largestIncrease) {
    ...
    monthWithLargestIncrease = finances[i][0]; 
  }
}

console.log( "Largest Increase: " + monthWithLargestIncrease + "$" + largestIncrease );

//Largest Decrease

var largestDecrease = 0;
var monthWithLargestDecrease = '';
...
for (var i = 1; i < finances.length; i++) {
  ...
  if (decrease > largestDecrease) {
    ...
    monthWithLargestDecrease = finances[i][0];
  }
}

console.log("Largest Decrease: " + monthWithLargestDecrease + "$-" + largestDecrease);
